...
class Rireki_rental(models.Model):
    ...
    haisou_yubin_m=models.CharField("郵便番号_元",max_length=30,blank=True)
    haisou_pref_m=models.CharField("都道府県_元",max_length=10,blank=True)
    haisou_city_m=models.CharField("市区町村_元",max_length=30,blank=True)
    haisou_banchi_m=models.CharField("番地_元",max_length=30,blank=True)
    haisou_build_m=models.CharField("建物名_元",max_length=30,blank=True)
    haisou_tel_m=models.CharField("電話番号_元",max_length=30,blank=True)  
